...
<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Manage Office Contact</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ URL::to('/home') }}">Home</a></li>
              <li class="breadcrumb-item">Spo</li>
              <li class="breadcrumb-item active">Manage Office Contact</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<div class="container">
    ...
    <div class="card-header pt-3  flex-row align-items-center justify-content-between">
      <h5 class="m-0 font-weight-bold">Manage Office Contact</h5>
     </div>
...
function ajaxRequest(){
    ...
    //axios post request
  axios.post('/admin/ofcontact',formData)
