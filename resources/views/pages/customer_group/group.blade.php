...
<div class="container">
    ...
    <div class="card-header pt-3  flex-row align-items-center justify-content-between">
      <h5 class="m-0 font-weight-bold">Customer Group</h5>
     </div>
              ...
              <div class="modal-body">
                <form id="myForm">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control form-control-sm" id="name"  type="text" placeholder="Enter Group Name...">
...
function ajaxRequest(){
  $('.submit').addClass('disabled').attr('disabled',true);
    ...
    //axios post request
    if (!id) {
        axios.post('/admin/group',formData)
        .then(function (response){
