...
<div class="container">
    ...
    <div class="card-header pt-3  flex-row align-items-center justify-content-between">
      <h5 class="m-0 font-weight-bold">@lang('key.permission.warehouse_permission.title')</h5>
     </div>
              ...
              <div class="modal-body">
                <form id="myForm">
                  ...
                  <div class="form-group">
                    <label class="font-weight-bold">@lang('key.permission.warehouse_permission.user'):</label>
                  ...
                  <table class="table table-sm table-bordered table-striped align-items-center display table-flush data-table">
                    <thead class="thead-light">
                     <tr>
                        ...
                        <th>@lang('key.permission.warehouse_permission.user')</th>
                        <th>@lang('key.permission.warehouse_permission.role')</th>
...
function ajaxRequest(){
  // $('.submit').addClass('disabled').attr('disabled',true);
    ...
    //axios post request
    if (!id) {
        axios.post('/admin/warehouse-permission',formData)
