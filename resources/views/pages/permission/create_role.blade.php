...
<div class="container">
    ...
    <div class="card-header pt-3  flex-row align-items-center justify-content-between">
      <h5 class="m-0 font-weight-bold">@lang('key.role.title')</h5>
     </div>
              ...
              <div class="modal-body">
                <form id="myForm">
                  ...
                  <div class="form-group">
                    <label class="font-weight-bold">@lang('key.role.role_name'):</label>
                    <input class="form-control form-control-sm" id="name"  type="text" placeholder="@lang('key.role.role_name_placeholder')">
...
$('.submit').text("@lang('key.buttons.save')");
 ...
 $(document).on('click','.edit',function(){
  $('#exampleModalLabel').text("@lang('key.role.title_update')");
