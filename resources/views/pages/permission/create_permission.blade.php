...
<div class="container">
    ...
    <div class="card-header pt-3  flex-row align-items-center justify-content-between">
      <h5 class="m-0 font-weight-bold">@lang('key.permission.title')</h5>
     </div>
              ...
              <div class="modal-body">
                <form id="myForm">
                  ...
                  <div class="form-group">
                    <label class="font-weight-bold">@lang('key.permission.permission_name'):</label>
                    <input class="form-control form-control-sm" id="name"  type="text" placeholder="@lang('key.permission.permission_name_placeholder')">
                ...
                <div class="table-responsive mt-2">
                  <table class="table table-sm table-bordered table-striped align-items-center display table-flush data-table">
                    <thead class="thead-light">
                     <tr>
                        <th>@lang('key.permission.no')</th>
                        <th>@lang('key.permission.permission_name')</th>
                        <th>@lang('key.permission.action')</th>
                     </tr>
                    </thead>
                    <tbody>
                    </tbody>
...
$('#Modalx').modal('show');
$('#id').val('');
$('#exampleModalLabel').text("@lang('key.permission.title_modal')");
$('.submit').text("@lang('key.buttons.save')");
}
 $(document).on('click','.edit',function(){
  $('#exampleModalLabel').text("@lang('key.permission.title_update')");
