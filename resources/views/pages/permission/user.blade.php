...
<div class="container">
    ...
    <div class="card-header pt-3  flex-row align-items-center justify-content-between">
      <h5 class="m-0 font-weight-bold">@lang('key.user.title')</h5>
     </div>
              ...
              <div class="modal-body">
                <form id="myForm">
                  ...
                  <div class="form-group">
                    <label class="font-weight-bold">@lang('key.user.name'):</label>
                  ...
                  <div class="form-group">
                    <label class="font-weight-bold">@lang('key.user.email'):</label>
                ...
                <div class="table-responsive mt-2">
                  <table class="table table-sm table-bordered table-striped align-items-center display table-flush data-table">
                    <thead class="thead-light">
                     <tr>
                        <th>@lang('key.user.no')</th>
                        <th>@lang('key.user.name')</th>
                        <th>@lang('key.user.email')</th>
                        <th>@lang('key.user.action')</th>
                     </tr>
                    </thead>
                    <tbody>
                    </tbody>
