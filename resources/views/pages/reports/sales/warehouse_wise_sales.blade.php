...
<div class="container">
    ...
    <div class="card-header pt-3  flex-row align-items-center justify-content-between">
      <h5 class="m-0 font-weight-bold">Warehouse Wise Sale Summery</h5>
      </div>
    <div class="card-body px-3 px-md-5">
      ...
      <div class="input-group">
        ...
        <div class="input-group mt-2">
         <label class="control-label col-sm-2 text-lg-right" for="type">Sales Type :</label>
         <div class="col-sm-9">
...
function Request(){
  ...
  type=$('#type').val()
  store=$('#store').val()
  axios.post('/admin/warehouse_wise_sales',{fromDate:fromDate,toDate:toDate,type:type,store:store})
  .then((res)=>{
    if (res.data.errors) {
    ...
    let html='';
      ...
      header=`<h5 style='text-align:center;margin-top:30px;line-height:0.6;'>Warehouse Wise Sale Summery</h5>
