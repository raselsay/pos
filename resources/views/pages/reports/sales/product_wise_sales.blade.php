...
<div class="container">
    ...
    <div class="card-header pt-3  flex-row align-items-center justify-content-between">
      <h5 class="m-0 font-weight-bold">@lang('key.product_wise_sale.title')</h5>
     </div>
    <div class="card-body px-3 px-md-5">
      ...
      <div class="input-group">
        ...
        <div class="input-group mt-2">
         <label class="control-label col-sm-2 text-lg-right" for="type">@lang('key.product_wise_sale.sale_type') :</label>
         <div class="col-sm-9">
            <select class="form-control form-control-sm" name="type" id="type">
            <option value="0">@lang('key.product_wise_sale.normal_sale')</option>
            <option value="1">@lang('key.product_wise_sale.advance_sale')</option>
            <option value="2">@lang('key.product_wise_sale.sale_return')</option>
            <option value="3">@lang('key.product_wise_sale.installment')</option>
          </select>
             <div id="type_msg" class="invalid-feedback">
             </div>
          </div>
...
function Request(){
  ...
  type=$('#type').val()
  product=$('#product').val();
  axios.post('/admin/product_wise_sales',{fromDate:fromDate,toDate:toDate,type:type,product:product})
  .then((res)=>{
    console.log(res)
    if (res.data.errors) {
    ...
    let html='';
       ...
       html+="<th width='30%'>@lang('key.report-common.customer_name')</th>"
      ...
      header=`<h5 style='text-align:center;margin-top:30px;line-height:0.6'>@lang('key.product_wise_sale.title')</h5>
