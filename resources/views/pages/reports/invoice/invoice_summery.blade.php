...
<div class="container">
    ...
    <div class="card-header pt-3  flex-row align-items-center justify-content-between">
      <h5 class="m-0 font-weight-bold">@lang('key.invoice_summary.title')</h5>
     </div>
    <div class="card-body px-3 px-md-5">
      <form>
        <div class="input-group">
         <label class="control-label col-sm-2 text-lg-right" for="type">@lang('key.invoice_summary.type') :</label>
         <div class="col-sm-9">
            <select class="form-control form-control-sm" name="type" id="type">
            <option value="0">@lang('key.invoice_summary.normal_sale')</option>
            <option value="1">@lang('key.invoice_summary.advance_sale')</option>
            <option value="2">@lang('key.invoice_summary.sale_return')</option>
            <option value="3">@lang('key.invoice_summary.installment')</option>
       ...
       <div class="row ml mt-1">       
        <label class="col-sm-2 text-lg-right">@lang('key.invoice_summary.date') :</label>
        <div class="input-group input-group-sm col-sm-9" id="date">
            <div class="input-group-prepend">
              <span class="input-group-text" id="inputGroup-sizing-sm">@lang('key.invoice_summary.from') :</span>
            </div>
            <input class="form-control form-control-sm" name="fromDate" id="fromDate">
            <div class="input-group-prepend">
              <span class="input-group-text" id="inputGroup-sizing-sm">@lang('key.invoice_summary.to') :</span>
            </div>
        ...
        <div class="col-md-2" id="submit">
          <button class="btn btn-sm btn-primary" onclick="Request()">@lang('key.invoice_summary.create_report')</button>
        </div>
            </div>
  </div>
</div>
...
function Request(){
  ...
  .then((res)=>{
    ...
    let html='';
       ...
       html+="<th width='20%'>@lang('key.report-common.date')</th>"
       ...
       html+="<th width='20%'>@lang('key.report-common.payable')</th>"
       html+='</tr>'
       html+="</thead>"
      ...
      header=`<h5 style='text-align:center;margin-top:30px;line-height:0.6;'>@lang('key.invoice_summary.title')</h5>
