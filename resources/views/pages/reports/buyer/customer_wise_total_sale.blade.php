...
<div class="container">
    ...
    <div class="card-header pt-3  flex-row align-items-center justify-content-between">
      <h5 class="m-0 font-weight-bold">Customer Wise Total Sale</h5>
      </div>
...
function Request(cond=null){
  ...
  type=$('#type').val()
  product=$('#product').val()
  axios.post('/admin/customer_wise_total_sale',{fromDate:fromDate,toDate:toDate,type:type,product:product})
  .then((res)=>{
    if (res.data.errors) {
    ...
    if(cond==1){
      let datax = [
            ...
            let settings = {
            fileName: 'customer_wise_total_sale',
            extraLength: 3, 
            writeOptions: {} 
          }
          xlsx(datax, settings)
    ...
    let html='';
       ...
       html+="<th width='15%'>Customer Name</th>"
       html+="<th width='10%'>Phone</th>"
       html+="<th width='15%'>Group</th>"
       html+="<th width='15%'>Spo</th>"
       html+="<th width='15%'>Adress</th>"
      ...
      header=`<h5 style='text-align:center;margin-top:30px;line-height:0.6'>Customer Wise Total Sale</h5>
