...
<div class="container">
    ...
    <div class="card-header pt-3  flex-row align-items-center justify-content-between">
      <h5 class="m-0 font-weight-bold">Customer Wise Payment Report</h5>
      </div>
...
function Request(cond=null){
  ...
  toDate=$('#toDate').val()
  axios.post('/admin/customer_wise_payment',{fromDate:fromDate,toDate:toDate})
  .then((res)=>{
    if (res.data.errors) {
    ...
    let html='';
       ...
       html+="<th width='20%'>Customer Name</th>"
      ...
      header=`<h5 style='text-align:center;margin-top:30px;line-height:0.6'>Customer Wise Payment</h5>
