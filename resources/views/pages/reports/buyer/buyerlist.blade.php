...
<div class="container">
    ...
    <div class="card-header pt-3  flex-row align-items-center justify-content-between">
      <h5 class="m-0 font-weight-bold">@lang('key.buyer_list.title')<img class="float-right buffer img-buffer d-none" src="{{asset('storage/admin-lte/dist/img/buffer.gif')}}" alt=""></h5>
     </div>
    <div class="card-body px-3 px-md-5">
      <h2 class="buffer d-none">@lang('key.buyer_list.message')</h2>
      <div class="p-2">
      <button class="btn btn-primary" onclick="Request()">@lang('key.buyer_list.create_report')</button>
      </div>
    </div>
  ...
  .then((res)=>{
    ...
    let html='';
      ...
      for (var i = 0; i < data.length; i++){
       ...
       html+="</tbody>"
      header=`<h4 style='text-align:center;line-height:0.5;margin-top:30px;'>@lang('key.buyer_list.title')</h4>
