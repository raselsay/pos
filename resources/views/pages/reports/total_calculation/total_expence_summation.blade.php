...
<div class="container">
    ...
    <div class="card-header pt-3  flex-row align-items-center justify-content-between">
      <h5 class="m-0 font-weight-bold">Total Expence Report</h5>
     </div>
...
function Request(){
  ...
  axios.post('/admin/total_expence_summation',formData)
  .then((res)=>{
    if (res.data.error){
    ...
    let html='';
       ...
       html+="<th width='20%'>@lang('key.report-common.no')</th>"
       html+="<th width='60%'>@lang('key.report-common.name')</th>"
       html+="<th width='20%'>@lang('key.report-common.credit')</th>"
       html+='</tr>'
       html+="</thead>"
      ...
      for (var i = 0; i < data.length; i++){
      	if(data[i]['rel_name']!=null && data[i]['credit']!=0.00){
       ...
       html+=`<tfoot>
                ...
                <tr>
                  <th colspan="2"></th>
                  <th style='text-align:right'>@lang('key.report-common.grand_total') : `+(credit).toFixed(2)+`</th>
                </tr>
              </tfoot>`;
      header=`<h4 style='text-align:center;margin-top:30px;line-height:0.6;'>Total Expence Report</h4>
