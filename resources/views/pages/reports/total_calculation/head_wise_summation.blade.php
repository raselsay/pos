...
<div class="container">
    ...
    <div class="card-header pt-3  flex-row align-items-center justify-content-between">
      <h5 class="m-0 font-weight-bold">Head Wise Summation</h5>
     </div>
...
function Request(){
  ...
  axios.post('/admin/head_wise_summation',formData)
  .then((res)=>{
    if (res.data.error){
    ...
    let html='';
      ...
      header=`<h4 style='text-align:center;margin-top:30px;line-height:0.6;'>Head Wise Summation</h4>
