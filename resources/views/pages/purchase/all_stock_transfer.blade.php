...
<div class="container">
    ...
    <div class="card-header pt-3  flex-row align-items-center justify-content-between">
      <h5 class="m-0 font-weight-bold">All Stock Transfer List</h5>
     </div>
    <div class="card-body px-3 px-md-5">
        <!-- Modal --> 
        <a class="btn btn-primary text-light font-weight-bold mb-2" href="{{URL::to('admin/stock_transfer')}}">
          New Transfer<i class="ml-1 fas fa-plus"></i>
        </a>
...
<script type="text/javascript">
   $('.data-table').DataTable({
        ...
        serverSide:true,
        ajax:{
          url:"{{ URL::to('/admin/all_stock_transfer') }}"
        },
        columns:[
          {
            data:'DT_RowIndex',
...
.then((isConfirmed) => {
  ...
  var id=$(this).data('id');
    axios.delete('/admin/stock_transfer/'+id,{_method:'DELETE'})
      .then((res)=>{
        if (res.data.message) {
