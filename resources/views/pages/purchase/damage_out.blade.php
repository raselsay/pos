...
<div class="container">
  <div class="card m-0">
    <div class="card-header pt-3  flex-row align-items-center justify-content-between">
      <h5 class="m-0 font-weight-bold">Damage Out<img class='buffer float-right d-none' src="{{asset('storage/admin-lte/dist/img/buffer.gif')}}" alt=""></h5>
     </div>
...
if (isValid==true) {
  ...
  $('.submit').attr('disabled',true);
   ...
   pay=$('#pay').val();
    ...
    axios.post('admin/damage_out',formData)
    .then(function(response){
